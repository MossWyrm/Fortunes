...
func _init(upg_name: String, upg_desc: String, card_id: int, init_cost: float, growth: BaseGrowthFormula, growth_modifier: float, stat: String, operation: ID.Operation, effect, max_p: int = -1):
	title = upg_name
