...
static func get_description(card: Card, bb_formatted: bool) -> String:
	...
	match card.id:
		...
		506: return _hierophant_description(bb_formatted)
		...
		512: return _justice_description(bb_formatted)
		513: return _hanged_man_description()
		514: return _death_description(bb_formatted)
		515: return _temperance_description(stats, bb_formatted)
		516: return _devil_description(stats, bb_formatted)
		517: return _tower_description(bb_formatted)
		518: return _star_description(stats)
