...
func reset_deck_stats():
	inversion_chance_modifier = GameConfig.DEFAULT_INVERSION_CHANCE
	max_deck_size = GameConfig.DEFAULT_MAX_DECK_SIZE
	min_deck_size = GameConfig.DEFAULT_MIN_DECK_SIZE
	clairvoyance = GameConfig.DEFAULT_CLAIRVOYANCE
	cup_stats.reset()
	wand_stats.reset()
...
func reset_pack_stats():
	packs = GameConfig.DEFAULT_PACKS
	pack_auto_draw = GameConfig.DEFAULT_PACK_AUTO_DRAW
	pack_auto_draw_speed = GameConfig.DEFAULT_PACK_AUTO_DRAW_SPEED
	pack_card_value = GameConfig.DEFAULT_PACK_CARD_VALUE
