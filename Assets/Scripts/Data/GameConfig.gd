...
const DEFAULT_CUP_VESSEL_QUANTITY = 2
...
const DEFAULT_SWORD_PAGE_MULTIPLIER = 2.0
...
const DEFAULT_MAJOR_QUANTITY_PER_CARD = 1
const DEFAULT_MAJOR_QUANTITY_PER_DECK = 1
...
const DEFAULT_MAJOR_HANGED_MAN = 5
...
const DEFAULT_MAJOR_MOON_EXPONENT = 1  # How much each Moon affects the exponent
const DEFAULT_MAJOR_SUN_STAR = 10
const DEFAULT_MAJOR_SUN_MOON = 3
const DEFAULT_MAJOR_SUN_EXPONENT = 1   # How much each Sun affects the exponent
